...
const ChatSupport: React.FC<ChatSupportProps> = ({ onMessageSent }) => {
  ...
  return (
    <div className="flex flex-col h-full max-h-96">
      {/* Chat Header */}
      <div className="bg-slate-800 text-white p-3 rounded-t-lg flex items-center gap-2">
        <MessageCircle className="w-4 h-4" />
        <span className="font-semibold text-sm">Authexa Support Chat</span>
        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse ml-auto"></div>
      </div>

      {/* Messages Container */}
      <div className="flex-1 bg-slate-700 p-3 overflow-y-auto min-h-[200px] max-h-64">
      ...
      {/* Input Area */}
      <div className="bg-slate-600 p-3 rounded-b-lg flex gap-2">
        <Input
          value={inputValue}
